# License Plate Detection Dataset + YOLOv11 Training Weights
...
Description
Contains approximately 10,126 labeled images categorized as License Plate, covering scenarios of cars, motorcycles, and different angles of license plate scenes. Suitable for parking lots, entrances and exits, and road surveillance. This data can be used for training with YOLOv8 or YOLO11. The included model is the fine-tuned version of YOLOv1n for license plate detection, which does not include text recognition.
